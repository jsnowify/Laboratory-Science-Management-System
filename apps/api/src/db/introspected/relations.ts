...
import { colleges, courses, users, departments, equipmentCategories, equipmentCatalog, equipmentAssets, borrowRequests, borrowRequestItems, borrowAllocations, returnRecords, isoRequisitions, borrowRequestStatusHistory, notifications, auditLogs } from "./schema";
...
export const equipmentCatalogRelations = relations(equipmentCatalog, ({one, many}) => ({
...
export const borrowRequestItemsRelations = relations(borrowRequestItems, ({one, many}) => ({
...
export const borrowAllocationsRelations = relations(borrowAllocations, ({one, many}) => ({
...
export const isoRequisitionsRelations = relations(isoRequisitions, ({one}) => ({
	borrowRequest: one(borrowRequests, {
...
export const borrowRequestStatusHistoryRelations = relations(borrowRequestStatusHistory, ({one}) => ({
	borrowRequest: one(borrowRequests, {
