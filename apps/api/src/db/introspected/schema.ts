...
export const accountStatus = pgEnum("account_status", ['pending', 'active', 'suspended', 'archived'])
export const allocationStatus = pgEnum("allocation_status", ['reserved', 'released', 'returned', 'cancelled'])
export const borrowRequestStatus = pgEnum("borrow_request_status", ['draft', 'submitted', 'under_review', 'approved', 'rejected', 'ready_for_release', 'borrowed', 'partially_returned', 'returned', 'cancelled'])
export const equipmentCondition = pgEnum("equipment_condition", ['excellent', 'good', 'fair', 'damaged'])
export const equipmentOperationalStatus = pgEnum("equipment_operational_status", ['active', 'maintenance', 'damaged', 'retired'])
export const personType = pgEnum("person_type", ['student', 'faculty'])
export const returnOutcome = pgEnum("return_outcome", ['normal', 'damaged', 'maintenance_required'])
export const userRole = pgEnum("user_role", ['super_admin', 'admin', 'student_faculty'])

export const borrowRequestNumberSeq = pgSequence("borrow_request_number_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "9223372036854775807", cache: "1", cycle: false })
export const isoRequisitionNumberSeq = pgSequence("iso_requisition_number_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "9223372036854775807", cache: "1", cycle: false })
...
export const borrowAllocations = pgTable("borrow_allocations", {
	id: uuid().defaultRandom().primaryKey().notNull(),
...
export const isoRequisitions = pgTable("iso_requisitions", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	borrowRequestId: uuid("borrow_request_id").notNull(),
...
export const borrowRequestStatusHistory = pgTable("borrow_request_status_history", {
	id: uuid().defaultRandom().primaryKey().notNull(),
	borrowRequestId: uuid("borrow_request_id").notNull(),
...
export const vwEquipmentAssetAvailability = pgView("vw_equipment_asset_availability", {	equipmentAssetId: uuid("equipment_asset_id"),
...
export const vwEquipmentInventorySummary = pgView("vw_equipment_inventory_summary", {	equipmentCatalogId: uuid("equipment_catalog_id"),
	equipmentName: varchar("equipment_name", { length: 150 }),
	categoryId: uuid("category_id"),
	categoryName: varchar("category_name", { length: 100 }),
...
export const vwCurrentCustody = pgView("vw_current_custody", {	allocationId: uuid("allocation_id"),
...
export const vwOverdueLoans = pgView("vw_overdue_loans", {	allocationId: uuid("allocation_id"),
	borrowRequestId: uuid("borrow_request_id"),
	requestNumber: varchar("request_number", { length: 30 }),
	borrowerId: uuid("borrower_id"),
	institutionalId: varchar("institutional_id", { length: 50 }),
...
export const vwAccountabilityRecords = pgView("vw_accountability_records", {	returnRecordId: uuid("return_record_id"),
	borrowRequestId: uuid("borrow_request_id"),
	requestNumber: varchar("request_number", { length: 30 }),
	borrowerId: uuid("borrower_id"),
	institutionalId: varchar("institutional_id", { length: 50 }),
...
export const vwBorrowingTrendsMonthly = pgView("vw_borrowing_trends_monthly", {	month: timestamp({ withTimezone: true, mode: 'string' }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const vwEquipmentUsage = pgView("vw_equipment_usage", {	equipmentCatalogId: uuid("equipment_catalog_id"),
	equipmentName: varchar("equipment_name", { length: 150 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const vwInventoryUtilization = pgView("vw_inventory_utilization", {	equipmentCatalogId: uuid("equipment_catalog_id"),
	equipmentName: varchar("equipment_name", { length: 150 }),
	categoryName: varchar("category_name", { length: 100 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	totalUnits: bigint("total_units", { mode: "number" }),
...
export const vwUserBorrowingFrequency = pgView("vw_user_borrowing_frequency", {	userId: uuid("user_id"),
	institutionalId: varchar("institutional_id", { length: 50 }),
...
export const vwCollegeBorrowingFrequency = pgView("vw_college_borrowing_frequency", {	collegeId: uuid("college_id"),
...
export const vwCourseBorrowingFrequency = pgView("vw_course_borrowing_frequency", {	courseId: uuid("course_id"),
...
export const vwPeakBorrowingPeriods = pgView("vw_peak_borrowing_periods", {	dayOfWeek: integer("day_of_week"),
...
export const vwEquipmentQrLookup = pgView("vw_equipment_qr_lookup", {	equipmentAssetId: uuid("equipment_asset_id"),
	qrToken: uuid("qr_token"),
	assetCode: varchar("asset_code", { length: 50 }),
	serialNumber: varchar("serial_number", { length: 100 }),
	equipmentCatalogId: uuid("equipment_catalog_id"),
